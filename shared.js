...
export function icon(name, size = 16) {
  const paths = {
    ...
    refresh: '<path d="M20 6v5h-5"/><path d="M18.3 16.5A7.5 7.5 0 1 1 19.7 9"/>',
    ...
    settings: '<circle cx="12" cy="12" r="4.5"/><circle cx="12" cy="12" r="1.6"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.9 4.9 7 7M17 17l2.1 2.1M19.1 4.9 17 7M7 17l-2.1 2.1"/>',
